...
if __name__ == '__main__':
    ...
    df_products = pd.read_csv('data/olist_order_items_dataset.csv', header=0, usecols=['order_id', 'product_id', 'price'])
    ...
    for bundle_size in bundle_size_vec:
        bundle_set, profit_bundle = kbundle.Kbundle_QP_relaxation(mean_vec, cov_mat, alpha, bundle_size, separate_profit_vec)
    ...
    accuracy = evaluate_prediction(predicted_cov_mat, copurchase_mat, mean_vec, price_vec, std_vec, sales_vec, delta_vec, alpha)
