...
def pi(mu, sigma_square, a, c):
	params = mu, sigma_square, a, c
...
def f_exponential(delta, *params):
	mu, sigma_square, a, c = params
	# exponential weight
	return -((norm.ppf(1-delta) * math.sqrt(math.fabs(sigma_square)) + mu) - c) * mapping(delta, a)
